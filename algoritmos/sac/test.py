...
# Cargar el modelo entrenado de SAC
load_path = r"C:\Users\karol\Documents\Master\gymduck\gym-duckietown\algoritmos\sac\model\SACModeloLineaRecta.zip"
model = SAC.load(load_path, device=device)
...
while True:
    # Predecir acción usando el modelo SAC entrenado
