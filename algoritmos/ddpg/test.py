...
load_path = r"C:\Users\karol\Documents\Master\gymduck\gym-duckietown\algoritmos\ddpg\model\ModeloDDPGLineaRecta4.zip"
model = DDPG.load(load_path, device=device)
